  ...
  >
    <div className="parallax_con">
      ...
      <div className="img1_title2">
        ...
        Enter Ink Mimic, your gateway to literary mastery! We've crafted a groundbreaking solution that empowers you to effortlessly absorb, replicate, and weave the magic of legendary wordsmiths into your own prose.         </div>
      </div>
    </div>
  </Parallax>
);
